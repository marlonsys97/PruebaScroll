       ...
       // $(function() {
        ...
        var dataBase=null;
            ...
            dataBase.onupgradeneeded = function(e){
                ...
                var object = dataBase.createObjectStore("prodcts", {keyPath: "serl", autoIncrement: true});
            ...
            function AddAll(){
                ...
                var data = active.transaction(["prodcts"], "readwrite");
                ...
                for (pr in prodctsBDD){
                    ...
                    object.add({codig : cod, nombr : nom, valor : val, inicial : ini, catgr : cat, _cant : can });
